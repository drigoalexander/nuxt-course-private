...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createError, getHeader, getCookie, parseCookies, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, assertMethod, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/h3/dist/index.mjs';
import { PrismaClient } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/@prisma/client/index.js';
import { Buffer } from 'buffer';
import crypto from 'crypto';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1 } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/radix3/dist/index.mjs';
import { createClient } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/@supabase/supabase-js/dist/main/index.js';
import { version, unref } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "mdClient": "SB-Mid-client-DiTL96vZaafVR4Md",
    "snapEndpoint": "https://app.sandbox.midtrans.com/snap/snap.js",
    "supabase": {
      "url": "https://svtlzpfanuilvsarqktq.supabase.co",
      "key": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN2dGx6cGZhbnVpbHZzYXJxa3RxIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTY5MzU2NjkwNywiZXhwIjoyMDA5MTQyOTA3fQ.62aFDt5l8guXdG78N2W_IVj3xvzlq0XHQKtlc99Kvs4",
      "redirect": false,
      "redirectOptions": {
        "login": "/login",
        "callback": "/confirm",
  ...
  "mdSecret": "SB-Mid-server-6NKGLwEOYhL5Pklts3ks_GYs",
  "mdEnpoint": "https://app.sandbox.midtrans.com/snap/v1/transactions",
  "supabase": {
    "serviceKey": ""
  }
};
...
const serverAssets = [{"baseName":"server","dir":"/Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/drigoalexander/Documents/Practice/NUXT/nuxt-course","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _sCnwzvr6gO = (function(nitro) {
...
const _bW6Vd7s24V = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const protectRoutes = async (event) => {
...
const _TYcYLs = defineEventHandler(async (event) => {
...
const _lazy_9NXDNN = () => Promise.resolve().then(function () { return _lessonSlug__get$1; });
const _lazy_3mj5WE = () => Promise.resolve().then(function () { return progress$1; });
const _lazy_YWGFQl = () => Promise.resolve().then(function () { return meta_get$1; });
const _lazy_imnfhI = () => Promise.resolve().then(function () { return paymentIntent$1; });
const _lazy_eA7EyB = () => Promise.resolve().then(function () { return webhook_post$1; });
const _lazy_cfkKc7 = () => Promise.resolve().then(function () { return hasAccess$1; });
const _lazy_HRiKXb = () => Promise.resolve().then(function () { return _id_$1; });
const _lazy_ihNgax = () => Promise.resolve().then(function () { return progress_post$1; });
const _lazy_chCU5T = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _TYcYLs, lazy: false, middleware: true, method: undefined },
  { route: '/api/course/chapter/:chapterSession/lesson/:lessonSlug', handler: _lazy_9NXDNN, lazy: true, middleware: false, method: "get" },
  { route: '/api/course/chapter/:chapterSession/lesson/:lessonSlug/progress', handler: _lazy_3mj5WE, lazy: true, middleware: false, method: undefined },
  { route: '/api/course/meta', handler: _lazy_YWGFQl, lazy: true, middleware: false, method: "get" },
  { route: '/api/midtrans/paymentIntent', handler: _lazy_imnfhI, lazy: true, middleware: false, method: undefined },
  { route: '/api/midtrans/webhook', handler: _lazy_eA7EyB, lazy: true, middleware: false, method: "post" },
  { route: '/api/user/hasAccess', handler: _lazy_cfkKc7, lazy: true, middleware: false, method: undefined },
  { route: '/api/user/linkWithPurchase/:id', handler: _lazy_HRiKXb, lazy: true, middleware: false, method: undefined },
  { route: '/api/user/progress', handler: _lazy_ihNgax, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_chCU5T, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_chCU5T, lazy: true, middleware: false, method: undefined }
];
...
const _lessonSlug__get = defineEventHandler(async (event) => {
  ...
  const lesson = await prisma$7.lesson.findFirst({
    where: {
      slug: lessonSlug,
      Chapter: {
        slug: chapterSession
...
const _lessonSlug__get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const progress = defineEventHandler(async (event) => {
  ...
  const lesson = await prisma$6.lesson.findFirst({
    where: {
      slug: lessonSlug,
      Chapter: {
        slug: chapterSlug
  ...
  return prisma$6.lessonProgress.upsert({
    where: {
      lessonId_userEmail: {
        lessonId: lesson.id,
        userEmail
...
const progress$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: progress
});
...
const meta_get = defineEventHandler(async (event) => {
  const course = await prisma$5.course.findFirst({
    select: {
      title: true,
      chapters: {
        select: {
...
const meta_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: meta_get
});
...
const paymentIntent = defineEventHandler(async (event) => {
  const config = useRuntimeConfig();
  const { title, email } = await readBody(event);
  const course = await prisma$4.course.findFirst({
    where: {
      title
    },
    select: {
  ...
  const { token } = await $fetch(`${config.mdEnpoint}`, {
    ...
    headers: {
      ...
      Authorization: "Basic " + Buffer.from(`${config.mdSecret}`).toString("base64")
    },
    body: {
      transaction_details: {
  ...
  try {
    await prisma$4.coursePurchase.create({
      data: {
        userEmail: email,
        courseId: course.id,
        paymentId: uuid
...
const paymentIntent$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
...
const webhook_post = defineEventHandler(async (event) => {
  ...
  if (transaction_status === "settlement" || transaction_status === "capture") {
    try {
      await prisma$3.coursePurchase.update({
        where: {
          paymentId: order_id
        },
        data: {
  ...
  } else if (transaction_status === "failure" || transaction_status === "cancel" || transaction_status === "deny" || transaction_status === "expire") {
    try {
      await prisma$3.coursePurchase.delete({
        where: {
          paymentId: order_id
        }
      });
...
const hasAccess = defineEventHandler(async (event) => {
  const { title } = await readBody(event);
  const user = event.context.user;
  const { id } = await prisma$2.course.findFirst({
    where: {
      title
    },
    select: {
  ...
  const coursePurchases = await prisma$2.coursePurchase.findMany({
    where: {
...
const hasAccess$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: hasAccess
});
...
const _id_ = defineEventHandler(async (event) => {
  ...
  const user = event.context.user;
  try {
    await prisma$1.coursePurchase.update({
      where: {
        paymentId: id
      },
      data: {
...
const progress_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: progress_post
});
...
const getClientManifest = () => import('file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/drigoalexander/Documents/Practice/NUXT/nuxt-course/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
