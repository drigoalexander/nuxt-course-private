import { effectScope, reactive, hasInjectionContext, getCurrentInstance, version, unref, inject, ref, watchEffect, watch, toRef, isRef, nextTick, shallowRef, shallowReactive, isReadonly, markRaw, toRaw, isReactive, computed, getCurrentScope, onScopeDispose, toRefs, isShallow, defineComponent, defineAsyncComponent, useSSRContext, mergeProps, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
    ...
    children: [
      {
        ...
        component: () => import("./_nuxt/_lessonSlug_-bfb5d5b4.js").then((m) => m.default || m)
      }
    ],
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/course-881da760.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-86b214af.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/login-807e08c9.js").then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-6c11205d.js"),
  logged: () => import("./_nuxt/logged-4fc537fc.js")
};
...
const components_plugin_Cn9svRnQra = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  ...
  components_plugin_Cn9svRnQra,
  plugin_server_XNCxeHyTuP,
  plugin
];
const __nuxt_component_0_lazy = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/page-1218e96a.js").then((m) => m.default || m));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const error = useError();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative w-full h-[100vh] flex items-center justify-center mx-auto flex-col gap-10" }, _attrs))}>`);
      if (unref(error).statusCode === 404) {
        _push(`<!--[--><h1 class="text-6xl font-bold">${ssrInterpolate(unref(error).statusCode)}</h1><p class="text-xl font-semibold">${ssrInterpolate(unref(error).message)}</p><button class="btn btn-solid-success"> Return To Course </button><!--]-->`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-1083fd4b.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export {
  ...
  defineStore as d,
  entry$1 as default,
  useSupabaseClient as e,
  appPageTransition as f,
  appKeepalive as g,
  useNuxtApp as h,
  asyncDataDefaults as i,
  fetchDefaults as j,
  useRequestFetch as k,
  useRequestHeaders as l,
  useRouter as m,
  navigateTo as n,
  nuxtLinkDefaults as o,
  defineNuxtRouteMiddleware as p,
  useSupabaseUser as u
};
