import { ref, shallowRef, toRef, getCurrentInstance, onServerPrefetch, unref, computed, reactive, getCurrentScope, onScopeDispose, readonly, watch, nextTick } from "vue";
import "hookable";
import { i as asyncDataDefaults, h as useNuxtApp, c as createError, j as fetchDefaults, k as useRequestFetch, l as useRequestHeaders } from "../server.mjs";
...
const useLessonWithCache = async (url) => {
...
const useCourse = async () => {
  return await useLessonWithCache("/api/course/meta");
};
export {
  useCourse as a,
  useLessonWithCache as u
};
//# sourceMappingURL=useCourse-74bb5d62.js.map
