...
import { s, a as d, A } from '../shared/nuxi.364a8bf1.mjs';
import { d as destr } from '../shared/nuxi.5195c8ce.mjs';
import { a as withBase, b as withQuery } from '../shared/nuxi.2ec68044.mjs';
import { u as upperFirst, k as kebabCase } from '../shared/nuxi.b2a717d6.mjs';
import { b as bold, c as cyan, g as gray, m as magenta, a as green } from '../shared/nuxi.cb18516a.mjs';
import 'node:zlib';
import 'node:stream';
import 'node:buffer';
import 'node:url';
...
async function findModuleByKeywords(query) {
  ...
  consola.success(
    `Found ${results.length} nuxt ${results.length > 1 ? "modules" : "module"} matching ${cyan(query)}:
`
  );
