...
/* build-hook-start *//*00001*/try { require('/users/drigoalexander/.vscode/extensions/wallabyjs.console-ninja-0.0.226/out/buildhook/index.js').default({tool: 'nuxt'}); } catch(cjsError) { try { import('file:///users/drigoalexander/.vscode/extensions/wallabyjs.console-ninja-0.0.226/out/buildhook/index.js').then(m => m.default.default({tool: 'nuxt'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
