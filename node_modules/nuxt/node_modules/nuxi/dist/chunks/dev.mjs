...
/* build-hook-start *//*00001*/try { require('/users/drigoalexander/.vscode/extensions/wallabyjs.console-ninja-0.0.227/out/buildhook/index.js').default({tool: 'nuxt'}); } catch(cjsError) { try { import('file:///users/drigoalexander/.vscode/extensions/wallabyjs.console-ninja-0.0.227/out/buildhook/index.js').then(m => m.default.default({tool: 'nuxt'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
import { d as defineCommand } from '../shared/nuxi.c627b411.mjs';
import './index2.mjs';
import 'node:http';
import 'node:https';
import 'node:util';
...
function _startSubprocess(devServer) {
  let childProc;
  const close = () => {
    childProc?.kill();
    childProc = void 0;
