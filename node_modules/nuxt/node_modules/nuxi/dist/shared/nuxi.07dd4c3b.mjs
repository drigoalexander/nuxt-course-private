...
import { j as jiti } from './nuxi.3da669df.mjs';
import require$$0 from 'stream';
import require$$0$1 from 'os';
import require$$0$2 from 'path';
import { b as braces_1, p as picomatch$1, u as utils$d, g as globParent$1 } from './nuxi.d1302898.mjs';
import require$$0$3 from 'util';
import require$$0$5 from 'events';
import require$$0$4 from 'fs';
import { c as commonjsGlobal } from './nuxi.357b3b4e.mjs';
import 'node:stream';
import { r as readPackageJSON } from './nuxi.8d9be659.mjs';
import { c as withTrailingSlash } from './nuxi.2ec68044.mjs';
import { j as join, a as relative, r as resolve, i as isAbsolute } from './nuxi.dcd5f40f.mjs';
...
Object.defineProperty(path$8, "__esModule", { value: true });
path$8.convertPosixPathToPattern = path$8.convertWindowsPathToPattern = path$8.convertPathToPattern = path$8.escapePosixPath = path$8.escapeWindowsPath = path$8.escape = path$8.removeLeadingDotSegment = path$8.makeAbsolute = path$8.unixify = void 0;
...
path$8.unixify = unixify;
function makeAbsolute(cwd, filepath) {
    return path$7.resolve(cwd, filepath);
}
path$8.makeAbsolute = makeAbsolute;
...
path$8.removeLeadingDotSegment = removeLeadingDotSegment;
path$8.escape = IS_WINDOWS_PLATFORM ? escapeWindowsPath : escapePosixPath;
function escapeWindowsPath(pattern) {
    return pattern.replace(WINDOWS_UNESCAPED_GLOB_SYMBOLS_RE, '\\$2');
}
path$8.escapeWindowsPath = escapeWindowsPath;
function escapePosixPath(pattern) {
    return pattern.replace(POSIX_UNESCAPED_GLOB_SYMBOLS_RE, '\\$2');
}
path$8.escapePosixPath = escapePosixPath;
path$8.convertPathToPattern = IS_WINDOWS_PLATFORM ? convertWindowsPathToPattern : convertPosixPathToPattern;
function convertWindowsPathToPattern(filepath) {
    return escapeWindowsPath(filepath)
        .replace(DOS_DEVICE_PATH_RE, '//$1')
        .replace(WINDOWS_BACKSLASHES_RE, '/');
}
path$8.convertWindowsPathToPattern = convertWindowsPathToPattern;
function convertPosixPathToPattern(filepath) {
    return escapePosixPath(filepath);
}
path$8.convertPosixPathToPattern = convertPosixPathToPattern;
...
/** Built-in value references. */
var symToStringTag = Symbol$1$1 ? Symbol$1$1.toStringTag : undefined;
