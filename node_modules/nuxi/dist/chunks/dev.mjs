...
/* build-hook-start *//*00001*/try { require('/Users/drigoalexander/.vscode/extensions/wallabyjs.console-ninja-1.0.268/out/buildHook/index.js').default({tool: 'nuxt'}); } catch(cjsError) { try { import('file:///Users/drigoalexander/.vscode/extensions/wallabyjs.console-ninja-1.0.268/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
import { fork } from 'node:child_process';
import { s as setupDotenv } from '../shared/nuxi.8fff7968.mjs';
import { d as defineCommand, S, a as c } from '../shared/nuxi.c6444792.mjs';
import './index2.mjs';
import 'node:http';
import 'node:https';
import 'node:util';
...
import { l as loadKit } from '../shared/nuxi.2879253c.mjs';
import { i as importModule } from '../shared/nuxi.0719fb20.mjs';
...
import 'util';
import 'tty';
import '../shared/nuxi.fe6b052c.mjs';
import 'events';
import 'stream';
import 'node:url';
import 'http';
...
import '../shared/nuxi.44b32a4a.mjs';
import '../shared/nuxi.ae708cae.mjs';
import 'node:assert';
import 'node:v8';
import '../shared/nuxi.a3ec6487.mjs';
import 'node:stream';
import '../shared/nuxi.0782a508.mjs';
...
async function _startSubprocess(devProxy) {
  let childProc;
  const kill = (signal) => {
    if (childProc) {
