...
/* build-hook-start *//*00001*/try { require('/Users/drigoalexander/.vscode/extensions/wallabyjs.console-ninja-1.0.266/out/buildHook/index.js').default({tool: 'nuxt'}); } catch(cjsError) { try { import('file:///Users/drigoalexander/.vscode/extensions/wallabyjs.console-ninja-1.0.266/out/buildHook/index.js').then(m => m.default.default({tool: 'nuxt'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
